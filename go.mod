...
// PATCHED: Use local fork with fixes for:
// - TransferToAgent/Escalate not visible in REST API
// - Superfluous WriteHeader error in SSE
// - Errors sent as JSON events instead of plain text
